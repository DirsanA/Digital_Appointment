...
const AddDoctors = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden text-black">
      ...
      {/* <aside className={`fixed top-0 left-0 bottom-0 w-64 bg-white shadow-md p-5 flex flex-col justify-between z-20 transform transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:left-0 md:translate-x-0 md:w-1/5`}> */}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-3 rounded-lg text-md font-semibold hover:bg-blue-700 transition-all shadow-md disabled:bg-blue-400"
                disabled={loading}
              >
