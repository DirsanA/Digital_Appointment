  ...
  return (
    <div className="relative bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="relative flex justify-center items-center bg-blue-900 h-96 overflow-hidden">
        ...
        >
          <motion.h1
            className="mb-6 font-bold text-white text-5xl md:text-7xl"
            variants={fadeIn}
          >
            <span>About</span> <span className="text-blue-300">D²</span>{" "}
            <span>Hospital</span>
          </motion.h1>
          <motion.div
          ...
          />
          <motion.p
            className="mx-auto max-w-2xl text-blue-100 text-xl"
            variants={fadeIn}
          >
              ...
              {activeTab === "history" && (
                ...
                >
                  <div className="bg-white shadow-sm p-8 border border-blue-50 rounded-2xl">
                    ...
                    <p className="mb-6 text-gray-600 text-lg leading-relaxed">
                      From humble beginnings to becoming a regional healthcare
                      leader, D² Hospital has consistently pushed the boundaries
                      of medical excellence while staying true to our founding
                      principles.
                    </p>

                    <div className="relative">
                      {/* Timeline */}
                      <div className="space-y-10 pl-8 border-blue-200 border-l-2">
                        {[
                          {
                            year: "1995",
                            title: "Foundation",
                            description:
                              "Established as a 50-bed general hospital with focus on community healthcare",
                          },
                          {
                            year: "2002",
                            title: "First Expansion",
                            description:
                              "Added specialized cardiac care unit and expanded to 150 beds",
                          },
                          {
                            year: "2010",
                            title: "JCI Accreditation",
                            description:
                              "Achieved international accreditation for quality and patient safety standards",
                          },
                          {
                            year: "2018",
                            title: "Research Center",
                            description:
                              "Opened state-of-the-art medical research facility with university partnerships",
                          },
                          {
                            year: "2022",
                            title: "Digital Transformation",
                            description:
                              "Implemented AI-assisted diagnostics and fully integrated electronic health records",
                          },
                        ].map((milestone, index) => (
                          <motion.div
                            key={index}
                          ...
                          >
                            <div className="-left-11 absolute flex justify-center items-center bg-blue-600 rounded-full w-8 h-8 font-bold text-white">
                              {milestone.year}
                            </div>
                            <h4 className="mb-2 font-bold text-blue-800 text-xl">
                              {milestone.title}
                            </h4>
                            <p className="text-gray-600">
              ...
              {activeTab === "facilities" && (
                ...
                >
                  <div className="bg-white shadow-sm p-8 border border-blue-50 rounded-2xl">
                    ...
                    <p className="mb-6 text-gray-600 text-lg leading-relaxed">
                      Our 300-bed tertiary care hospital features the most
                      advanced medical technology in the region, supported by
                      specialized centers of excellence across all major medical
                      disciplines.
                    </p>
                      ...
                      {[
                        {
                          ...
                          description:
                            "Featuring hybrid ORs, 24/7 cath lab, and advanced ECMO capabilities",
                          icon: (
                        ...
                        },
                        {
                          ...
                          description:
                            "With intraoperative MRI, robotic-assisted neurosurgery, and stroke center",
                          icon: <FaFlask className="text-blue-500 text-3xl" />,
                        },
                        {
                          title: "Cancer Center",
                          description:
                            "Comprehensive oncology services including proton therapy and precision medicine",
                          icon: (
                            <FaClinicMedical className="text-purple-500 text-3xl" />
                          ),
                        },
                        {
                          title: "Women's Health",
                          description:
                            "From advanced fertility treatments to robotic gynecologic surgery",
                          icon: <FaUserMd className="text-pink-500 text-3xl" />,
                        },
                      ].map((facility, index) => (
                        <motion.div
                          key={index}
                          className="bg-gradient-to-br from-gray-50 to-white hover:shadow-md p-6 border border-gray-200 rounded-xl transition-all duration-300"
                          whileHover={{ y: -5 }}
                        >
                          <div className="flex items-start space-x-4">
                            ...
                            <div>
                              <h4 className="mb-2 font-bold text-gray-800 text-xl">
                                {facility.title}
                              </h4>
                              <p className="text-gray-600">
                    ...
                    <div className="bg-blue-50 mt-8 p-6 rounded-xl">
                      <h4 className="mb-3 font-bold text-blue-800 text-xl">
                        Supporting Infrastructure
                      </h4>
                      <ul className="gap-4 grid md:grid-cols-2 text-gray-700">
                        <li className="flex items-center">
                          <span className="bg-blue-100 mr-3 p-1 rounded-full text-blue-600">
                            ✓
                          </span>
