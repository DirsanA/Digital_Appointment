...
const PatientHistory = () => {
    ...
    useEffect(() => {
        const fetchHistory = async () => {
            try {
                ...
                const response = await axios.get(`http://localhost:5000/api/appointments/patient/${patientId}/history`);
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-6">My Appointment History</h2>
